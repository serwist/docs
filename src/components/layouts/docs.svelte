<script lang="ts" module>
  import TwoslashHover from "$components/twoslash-hover.svelte";
...
<script lang="ts">
  ...
  import { TocObserver } from "$lib/toc-observer.svelte";
...
<main id="main-content" class="flex w-full flex-col xl:flex-row xl:justify-between">
  <nav
    class="shrink-0 px-6 pt-6 md:px-12 xl:sticky xl:top-(--navbar) xl:order-last xl:max-h-[calc(100dvh-var(--navbar))] xl:w-[clamp(350px,25vw,700px)] xl:px-4 print:hidden"
