...
<span
  class={clsx(
    ...
    isActive ? (hiddenOnMobileActive ? "hidden md:block" : "bg-neutral-250 dark:bg-neutral-800") : "hover:bg-neutral-250 dark:hover:bg-neutral-800",
...
>
  <a
    {href}
    class={clsx(
      "h-full w-full gap-2 px-3 py-2 font-medium wrap-break-word text-black dark:text-white",
